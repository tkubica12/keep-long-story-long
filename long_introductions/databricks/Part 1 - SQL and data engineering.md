...
# Pandas API on Spark is distributed solution that scales to much larger datasets
# See number of tasks running
# Nevertheless - our dataset is so small that overhead of distributed processing is not worth it
import pyspark.pandas as ps
psdf = ps.DataFrame(df)
psdf[psdf.age > 30].display()
